...
<body style="background:${colors.background}; font-family:Arial,sans-serif; color:${colors.text}; margin:0; padding:0;">
  <div style="max-width:500px; margin:40px auto; background:${colors.card}; border-radius:8px; box-shadow:0 2px 8px ${colors.primary}22; padding:32px;">
    ...
    <div style="font-size:16px; margin-bottom:24px;">
      <p>Hello,</p>
      <p>You have requested to reset your password for your ZENGA account (<strong>${email}</strong>).</p>
      ...
      <ul style="color:#666;">
        ...
        <li>Use this code only on the official ZENGA website</li>
    ...
    <div style="margin-top:32px; font-size:12px; color:#888; text-align:center;">
      &copy; 2025 ZENGA. All rights reserved.<br>
...
<body style="background:${colors.background}; font-family:Arial,sans-serif; color:${colors.text}; margin:0; padding:0;">
  <div style="max-width:500px; margin:40px auto; background:${colors.card}; border-radius:8px; box-shadow:0 2px 8px ${colors.primary}22; padding:32px;">
    ...
    <div style="font-size:16px; margin-bottom:24px;">
      <p>Hello,</p>
      <p>Your password for your ZENGA account (<strong>${email}</strong>) has been successfully changed.</p>
      ...
      <div style="text-align:center; margin:24px 0;">
        <a href="mailto:support@ZENGA.com" style="background:${colors.primary}; color:white; padding:12px 24px; text-decoration:none; border-radius:6px; display:inline-block;">Contact Support</a>
      </div>
    </div>
    <div style="margin-top:32px; font-size:12px; color:#888; text-align:center;">
      &copy; 2025 ZENGA. All rights reserved.<br>
...
You have requested to reset your password for your ZENGA account (${email}).

Reset Code: ${resetToken}

Important:
- This code will expire in 15 minutes
- Use this code only on the official ZENGA website
- Never share this code with anyone

If you didn't request this reset, please ignore this email and your password will remain unchanged.

© 2025 ZENGA. All rights reserved.
...
Your password for your ZENGA account (${email}) has been successfully changed.

Important Security Notice:
- You'll need to log in again on all devices
- All existing sessions have been terminated
- If you didn't make this change, contact support immediately at support@ZENGA.com
