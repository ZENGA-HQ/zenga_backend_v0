...
<body style="font-family:Arial,Helvetica,sans-serif;color:${text};margin:0;padding:24px;background:#f6f8fb;">
  <div style="max-width:600px;margin:0 auto;background:${bg};padding:24px;border-radius:8px;">
    <h2 style="color:${primary};margin:0 0 8px;">New sign-in to your ZENGA account</h2>
    <p style="margin:0 0 12px;">Hello ${nameOrEmail}, we detected a new sign-in to your ZENGA account.</p>
    ${
      details
    ...
    <p style="font-size:12px;color:#6b7280;margin-top:18px;">ZENGA • Secure crypto payments</p>
  </div>
</body>
</html>`;
}
